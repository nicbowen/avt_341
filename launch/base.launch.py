...
def generate_launch_description():
    ...
    launch_description = LaunchDescription([
        ...
        DeclareLaunchArgument('grid_llx', default_value='-400.0', description="Elevation grid - X coordinate grid bottom left anchor point."),
        DeclareLaunchArgument('grid_lly', default_value='-400.0', description="Elevation grid - Y coordinate grid bottom left anchor point."),
